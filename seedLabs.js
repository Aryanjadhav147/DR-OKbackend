...
const labs = [
  {
    ...
    slots: ["09:00 AM", "10:00 AM", "11:00 AM", "01:00 PM", "03:00 PM", "05:00 PM"],
    tests: [
      { id: "t1", name: "Complete Blood Count (CBC)", price: 450, preparation: "None" },
      { id: "t2", name: "Fasting Blood Sugar", price: 200, preparation: "Fasting 10-12 hours" },
      { id: "t3", name: "Thyroid Profile (T3, T4, TSH)", price: 800, preparation: "None" }
    ]
  },
  {
    ...
    tests: [
      { id: "t4", name: "Chest X-Ray", price: 600, preparation: "Remove metal objects" },
      { id: "t5", name: "MRI Scan (Brain)", price: 4500, preparation: "Appointment Required" },
      { id: "t1", name: "Complete Blood Count (CBC)", price: 500, preparation: "None" }
    ]
  },
  {
    ...
    tests: [
      { id: "t6", name: "Lipid Profile", price: 750, preparation: "Fasting 12 hours" },
      { id: "t7", name: "Vitamin D Test", price: 1200, preparation: "None" },
      { id: "t2", name: "Fasting Blood Sugar", price: 250, preparation: "Fasting 10-12 hours" }
    ]
  }
];
